...
DFT_ModuleAuCarre proc 
	...
	mov r3,#0x00 ; 
	mov r7,#0x00 ; on va mettre la somme 
...
; on calcule i*k on le met dans r6
mul r6,r1,r3
add r6,#0x3F
;on calcule le cosinus on le met dans r4
ldrsh r4,[r2,r6,lsl #1]
;on fait la somme de cos*x(i)
mla r7,r5,r4,r7
