...
for	ldrsh r8, [r0, r7, LSL #1]
	...
	mul r12, r1, r7
	and r12, #63 ;modulo 2pi
	
	 	   
	      
	
	; on calcule le cosinus et on le stock dans r10
	ldrsh r10, [r2, r12, LSL #1]
        ; on calcule le sinus et on le stock dans r10
	ldrsh r12, [r3, r12, LSL #1]
	
	; calcul de Im et Re
	mla r4, r8, r10, r4 ;relle
	mla r5, r8, r12, r5 ;imaginaire
